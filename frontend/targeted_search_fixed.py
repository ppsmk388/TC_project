...
def render_targeted_search_page():
    ...
    if current_theme == 'dark':
        ...
        card_style = "background: #2d3748; border: 2px solid #4a5568; color: #e2e8f0;"
        tag_style = "background: #2b6cb0; color: #bee3f8;"
        text_color = "#e2e8f0"
    else:
        ...
        tag_style = "background: #e3f2fd; color: #1976d2;"
        text_color = "#495057"
    ...
    with col1:
        ...
        with col1_2:
            experience_level = st.selectbox(
                "Experience Level",
                ["PhD Student", "Master Student", "Both", "Postdoc"],
                index=2
            )
